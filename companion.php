...
if ( defined( 'IS_ATOMIC_JN' ) && IS_ATOMIC_JN ) {
	...
	if ( defined( 'IS_WP_STUDIO' ) && IS_WP_STUDIO ) {
		...
		// Jurassic.Ninja specific hooks/actions.
...
function companion_admin_notices() {
    ...
    <div class="notice notice-success is-dismissible jn_notice">
        ...
        <p>
            <strong><span id="jurassic_url"
                          class="jurassic_ninja_field"><?php echo esc_html( network_site_url() ); ?></span></strong>
		...
		if ( ! defined( 'IS_ATOMIC_JN_ANONYMOUS' ) ) {
			?>
            <p>
                <strong>SSH User:</strong> <code id="jurassic_ssh_user"
                                                 class="jurassic_ninja_field"><?php echo esc_html( $sshuser ); ?></code>
				<?php clipboard( 'jurassic_ssh_user' ); ?>
                <strong>Password:</strong> <code id="jurassic_ssh_password"
                                                 class="jurassic_ninja_field"><?php echo esc_html( $ssh_password ); ?></code>
            ...
            <p>
                <strong>Server path:</strong> <code id="jurassic_ninja_server_path"
                                                    class="jurassic_ninja_field"><?php echo esc_html( $path ); ?></code>
				<?php clipboard( 'jurassic_ninja_server_path' ); ?>
            </p>
            <p>
                <strong>Jetpack rsync command:</strong> <code id="jurassic_ninja_rsync_path"
                                                              class="jurassic_ninja_field"><?php echo esc_html( $rsync_command ); ?></code>
